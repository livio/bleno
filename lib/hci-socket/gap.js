...
Gap.prototype.startAdvertisingAltBeacon = function(data) {
  ...
  var advertismentDataLength = 5 + dataLength;
  var scanDataLength = 0;
  
  var i = 0;
  var advertismentData = new Buffer(advertismentDataLength);
  
  advertismentData[i++] = 0x02;
  advertismentData[i++] = 0x01;
  advertismentData[i++] = 0x06;
  
  advertismentData[i++] = 0x1B;
  
  advertismentData[i++] = 0xFF;
  
  for (var j = 0; j < dataLength; j++) {
    advertismentData[i++] = data[j];
  }
  
  var scanData = new Buffer(scanDataLength);
  
  this.startAdvertisingWithEIRData(advertismentData, scanData);
